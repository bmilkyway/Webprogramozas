...
if(isset($_POST['felhasznalo']) && isset($_POST['jelszo']) && isset($_POST['vezeteknev']) && isset($_POST['utonev'])) {
    try {
        ...
        $dbh = new PDO('mysql:host=localhost;dbname=felhasznalok', 'webdani', '',
        ...
        if($row = $sth->fetch(PDO::FETCH_ASSOC)) {
            ...
            if($count = $stmt->rowCount()) {
                ...
                $uzenet = "<h1>Tisztelt ". $_POST['utonev']."!</h1> <br>Az regisztrációja sikeres volt!.<br>A folytatáshoz kérem jelentkezzen be!<p>Ezt a menüszalag, bejelentkezés gombján teheti meg!";                     
                $ujra = false;
            }
            else {
